...
import com.sfeir.tweetstorage.service.GoogleSentimentAnalyzer;
...
public class TweetSentimentEmitter {
    ...
    @StreamListener(target = TweetStorageChannel.INPUT_USER_TWEET_DATA)
    @SendTo(TweetStorageChannel.OUTPUT_USER_TWEET_STATS_DATA)
